...
* Predictors: gestational age (gest_age), mom's age at delivery (mom_age), and mom's pre-pregnancy BMI (mom_bmi), avg # of cigarettes smoked per day during pregnancy (n_cig)  
I am interested observing maternal health, maternal health behavior, and early vs. full-term pregnancy's impact birth weight. 

1. Setup the regression model (bw_model1)
2. Glance/tidy for a quick summary of the model and to see whether the selected variables seem appropriate
```{r}
bw_model1 = bw_df %>% 
